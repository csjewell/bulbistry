...
func (r *Database) Create(website Website) (*Website, error) {
...
func (r *Database) GetByName(name string) (*Website, error) {
...
func (r *Database) Update(id int64, updated Website) (*Website, error) {
    if id == 0 {
